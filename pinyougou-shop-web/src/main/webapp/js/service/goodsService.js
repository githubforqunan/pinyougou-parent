...
app.service('goodsService',function($http){
	...
	this.submitCheck = function(ids){
		return $http.get("../goods/submitCheck.do?ids="+ids);
	}
	
	this.makebale = function (ids) {
        return $http.get("../goods/marketable.do?ids="+ids);
    }

    this.findLoginName = function () {
        return $http.get("../goods/findLoginName.do");
    }
});
