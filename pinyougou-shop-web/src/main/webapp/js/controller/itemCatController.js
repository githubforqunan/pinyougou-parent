	...
	$scope.setList = function(){
		...
		if($scope.entity_2==null){
			if($scope.entity_1==null){
				$scope.firstTilte = "";
				$scope.secondTilte = "顶级分类列表";
				$scope.parentId="0";
			}else{
				$scope.firstTilte = "顶级分类列表";
				$scope.secondTilte = $scope.entity_1.name;
				$scope.parentId=$scope.entity_1.id;
			}
		}else{
			$scope.firstTilte = $scope.entity_1.name;
			$scope.secondTilte = $scope.entity_2.name;
